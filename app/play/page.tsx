...
export const metadata = {
  title: "Intake Training — Lawyered",
  description:
    "Review intake files for a small firm. Spot signals, filter clients, and build a healthy practice.",
};

export default function IntakeHub() {
  const totalScenarios = allDays.reduce(
    (sum, day) => sum + day.cases.length,
    0,
  );
            ...
            <div className="max-w-3xl space-y-5">
              ...
              <div className="space-y-4">
                ...
                <p className="max-w-2xl text-lg leading-7 text-[var(--text-secondary)] sm:text-xl">
                  Review a 10-file intake day for a small firm. Open ready
                  files, pause thin ones, and decline the wrong fits.
                </p>
              </div>
              <div className="flex flex-wrap gap-3 text-sm">
                <span className="stamp text-[var(--accent-red)]">
                  Filter Clients
                </span>
                <span className="signal-chip rounded-full px-3 py-1 font-medium">
                  Spot signals
                </span>
                <span className="signal-chip rounded-full px-3 py-1 font-medium">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.4fr_0.9fr]">
          <div className="card rounded-xl px-6 py-6 sm:px-8">
            ...
            <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <p className="max-w-xl text-sm leading-6 text-[var(--text-secondary)]">
                Start with Day 1. Later days hide more risk behind cleaner
                files.
              </p>
            </div>
            {dayLoadErrors.length ? (
              <div className="card mt-4 rounded-xl px-4 py-4 text-sm leading-6">
                Some intake days could not be loaded. The available days still
                work.
              </div>
            ) : null}
          </div>
          ...
          <aside className="card rounded-xl px-6 py-6">
            ...
            <ul className="mt-5 space-y-4 text-sm leading-6 sm:text-base">
              ...
              <li>
                Fee friction, lawyer churn, and bad motives raise risk.
              </li>
